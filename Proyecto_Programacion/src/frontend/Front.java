...
public class Front {
    ...
    ImageIcon fondoIcon = new ImageIcon(Front.class.getResource("/frontend/imagenes/imagenFondo.jpg")); // Actualiza la ruta
    Image imagenFondo = fondoIcon.getImage();

    // Crear JPanel personalizado para fondo
    ...
    frame.setContentPane(panelFondo); // Usamos este panel como fondo de toda la ventana
    ...
    bienvenida.setForeground(Color.WHITE); // Para que se vea sobre la imagen
    bienvenida.setBorder(BorderFactory.createEmptyBorder(50, 50, 30, 50));
    panelFondo.add(bienvenida, BorderLayout.NORTH);

    // Panel de botones
    JPanel opciones = new JPanel(new GridLayout(2, 2, 20, 20));
    opciones.setOpaque(false); // Muy importante para que se vea el fondo
    opciones.setBorder(BorderFactory.createEmptyBorder(50, 50, 50, 50));
