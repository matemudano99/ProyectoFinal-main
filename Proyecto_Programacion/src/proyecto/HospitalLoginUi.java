...
public class HospitalLoginUi {
	...
	public static void gestionPacientes(String rol) {
		...
		btnHistorial.addActionListener(e -> JOptionPane.showMessageDialog(frame, "Funcionalidad no implementada aún."));

		JButton btnHabitaciones = new JButton("Asignación de Habitaciones");
		btnHabitaciones.addActionListener(e -> JOptionPane.showMessageDialog(frame, "Funcionalidad no implementada aún."));

		JButton btnSolicitudes = new JButton("Solicitudes de Atención Médica");
		btnSolicitudes.addActionListener(e -> JOptionPane.showMessageDialog(frame, "Funcionalidad no implementada aún."));
